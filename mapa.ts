...
interface ConceptNode {
    ...
    isRoot?: boolean;
    isProcess?: boolean;
    miniDiagram?: 'latency' | 'cascade' | 'throughput';
    appIcon?: string;
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const svgLayer = document.getElementById('svg-layer') as any as SVGSVGElement;
    ...
    function focusOnNode(id: string, instant = false) {
    ...
    refModal.addEventListener('click', (e) => { if (e.target === refModal) refModal.classList.remove('active'); });
});
